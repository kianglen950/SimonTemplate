...
namespace SimonSays
{
    public partial class GameScreen : UserControl
    {
        ...
        SoundPlayer greenSound = new SoundPlayer();
        SoundPlayer redSound = new SoundPlayer();
        SoundPlayer yellowSound = new SoundPlayer();
        SoundPlayer blueSound = new SoundPlayer();
        SoundPlayer mistakeSound = new SoundPlayer();
        public GameScreen()
        {
            InitializeComponent();
        }
